...
def conv_network_2(batch_size, patch_size, depth, num_hidden, num_steps,
...
conv_network_2(batch_size=16, patch_size=5, depth=16, num_hidden=64, num_steps=5001,
               learning_rate=5e-3, decay_steps=10000, decay_rate=0.95)
